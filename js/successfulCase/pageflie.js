...
//			}
		...
		events : function() {
			...
			// The next slide button
			$('.yf', $this.$element).on("click", function() {
				nextClick(false)
			});

			// The previous slide button
			$('.zf', $this.$element).on("click", function() {
				prevClick(false)
			});
      ...
      //console.log("autoRun : auto ");
        ...
        //console.log("autoRun :hovering = true");
				hovering = true;
        ...
        //console.log("autoRun :hovering = false");
        ...
        autoslide = setInterval(function() {
          //console.log("autoRun to next");
          //$this.$element.find('.next').click();
          if(hovering === false) {
            $this.$element.find('.yf').click();
          }
